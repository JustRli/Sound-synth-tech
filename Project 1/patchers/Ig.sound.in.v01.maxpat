{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 531.0, 194.0, 1000.0, 780.0 ],
        "boxes": [
            {
                "box": {
                    "id": "obj-16",
                    "items": [ "adc", ",", "white", "noise", ",", "metro", ",", "cycle", ",", "playlist" ],
                    "maxclass": "umenu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "int", "", "" ],
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 712.0, 80.0, 150.0, 92.0 ],
                    "quality": "basic",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 605.0, 97.0, 88.0, 22.0 ],
                    "text": "cycle~ 200"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 605.0, 150.0, 73.0, 22.0 ],
                    "text": "*~ 0.2"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 498.0, 97.0, 88.0, 22.0 ],
                    "text": "metro 500"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 498.0, 150.0, 62.0, 22.0 ],
                    "text": "click~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 391.0, 97.0, 51.0, 22.0 ],
                    "text": "noise~"
                }
            },
            {
